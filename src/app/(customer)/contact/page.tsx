...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Working Hours',
      content: 'Mon - Sun',
      subtitle: '24/7 Delivery Service',
    },
  ];
  ...
  const faqCategories = [
    {
      ...
      answer: 'Once you place an order, you\'ll receive a confirmation with a tracking link. You can also track your order in real-time from your account dashboard.',
    },
    {
      question: 'What is your refund policy?',
      answer: 'If you\'re not satisfied with your order, please contact us within 24 hours. We offer full refunds for orders that don\'t meet our quality standards.',
    },
    {
      question: 'Do you deliver to my area?',
      answer: 'We currently deliver to most areas within the city. Enter your address on the checkout page to confirm delivery availability to your location.',
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="mt-8 p-6 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl text-white">
                <h3 className="text-xl font-bold mb-2">Need Immediate Help?</h3>
                <p className="text-orange-100 mb-4">
                  Our customer support team is available 24/7 for urgent inquiries.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gray-100 rounded-3xl h-96 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mt-2">Add your Google Maps embed here</p>
            </div>
          </div>
        </div>
      </section>
